define(['views/index', 'views/userhome', 'views/register', 'views/login', 'views/landing',
        'views/forgotpassword', 'views/profile', 'views/all_reviews', 'views/404', 'models/Account',
        'models/StatusCollection', 'models/ReviewCollection', 'vent'],
function(IndexView, UserHomeView, RegisterView, LoginView, LandingView, ForgotPasswordView, ProfileView, AllReviewsView, P404View,
         Account, StatusCollection, ReviewCollection, vent) {
