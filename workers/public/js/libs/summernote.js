...
(function (factory) {
  ...
  var Dialog = function () {
    ...
    var editor_s3_upload = function(e, _imageUrl, _imageBtn){
      console.log("inside summernote_editor_s3_upload function");

      // changed_element = $($('.note-image-input').parent());
      ce = $(e);
      // console.log(ce);
      var parent_post_div = ce.closest(".new-post-div");
      
      if(!parent_post_div.length)
        var parent_post_div = ce.closest(".post-div");
      
      var parent_post_id = parent_post_div.attr("id");

      changed_element_parent = $(ce.parent());
      changed_status_element = $(changed_element_parent.find("h5")[0]);

      var s3upload = new S3Upload({
          // file_dom_selector: '#user_profile_img_edit',
          // file_dom_selector: '.note-image-input',
          file_dom_selector: null, // this needs to be null for file_dom_element
          file_dom_element: e, // #TODO#DONE need changes in s3upload.js
          s3_sign_put_url: '/sign_s3',
          // file_opts: 'question_3022',
          ...
          onFinishS3Put: function(public_url) {
              ...
              _imageUrl.val(public_url);
              toggleBtn(_imageBtn, _imageUrl.val());
              // return public_url;
          },
    ...
    this.showImageDialog = function ($dialog, fnInsertImages, fnInsertImage) {
      ...
      $imageDialog.on('shown.bs.modal', function () {
        $imageInput.on('change', function () {
          ...
          // s3_public_url = 
          editor_s3_upload(this, $imageUrl, $imageBtn);
          // console.log(s3_public_url);
          // $imageUrl.val(s3_public_url);
