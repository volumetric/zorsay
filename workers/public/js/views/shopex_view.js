define(['text!templates/review.html', 'css!styles/font-awesome.css', 'css!styles/summernote.css'], function(reviewTemplate) {
  console.log("shopex view ...")
  var reviewView = Backbone.View.extend({
    ...
    initialize: function() {
      console.log("shopex view initialized")
    ...
    render: function() {
      ...
      console.log("in shopex view render function");
