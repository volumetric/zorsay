// define(['Backbone', 'text!templates/zs_comment_template.html'], function(b, zsCommentTemplate) {
define(['Backbone', 'text!templates/zs_comment_template.html'], function(b, zsCommentTemplate) {
  var zsCommentView = Backbone.View.extend({
    tagName: 'div',
    // el: 'body',
    ...
    initialize: function(args) {
      console.log("zs comment view initialized")
      // console.log(this.model);
      // console.log(args.user_info);
    ...
    render: function() {
      ...
      // console.log("in zs comment view render function");
      // $(this.el).html(_.template(reviewTemplate, {}));
      
      comment_data = this.model.attributes;
      // comment_data._author = {name:{}};
      comment_data._author = this.user_info;

      // console.log("this.model");
      // console.log(this.model);
      // console.log(this.user_info._author);
      
      // comment_data._author = this.user_info._author

      // console.log({comment_data : comment_data});

      $(this.el).html(_.template(zsCommentTemplate, JSON.stringify({comment_data : comment_data})));
